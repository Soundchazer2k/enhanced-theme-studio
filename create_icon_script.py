...
text_width, text_height = (
    draw.textsize(text, font=font) if hasattr(draw, "textsize") else font.getsize(text)
)
...
try:
    ...
    print(
        "You may need to convert app_icon.png to .ico format manually using an online converter."
    )
